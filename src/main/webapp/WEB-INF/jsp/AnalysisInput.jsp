...
<head>
    ...
    <link rel="stylesheet" href="../../css/AnalysisInput.css">
            ...
            <ul class="mymenu" id="mymenu">
                ...
                <li ><div class="link">试卷分析</div>
                    <ul class="submenu" id="usermanager">
                        ...
                        <li><a href="/liAnalysisInput" id="active" >数据录入</a></li>
            ...
            <div id = "banner">
                <div class="inner">
                    ...
                    <div class="input-donghua">
                        ...
                        <form action="/analysisInputSubmit" method="post" enctype="multipart/form-data" class="divfile">
