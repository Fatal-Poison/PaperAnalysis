...
<head>
    ...
    <link rel="stylesheet" href="../../css/KnowledgePaper.css">
            ...
            <div class="content-show">
                ...
                <div class="content-evaluate">
                        ...
                        <div>
                            ...
                            <div class="answer">
                                ${sessionScope.knowledgePaper.answer1}
                            </div>
                        </div>
                        <div>
                            <h5>2.试卷分析（教学效果） （考生掌握程度、考生错误率较高的知识点分布及原因）</h5>
                            <div class="answer">
                                ${sessionScope.knowledgePaper.answer2}
                            </div>
                        </div>
                        <div>
                            <h5>3.存在的问题、改进措施及建议 （着重分析教与学中的薄弱环节，并提出改进措施或建议）</h5>
                            <div class="answer">
                                ${sessionScope.knowledgePaper.answer3}
                            </div>
                        </div>
                            <form method="post" action="/knowledgePaperDownload" target="_blank" onsubmit="downloadPaperSubmit()">
